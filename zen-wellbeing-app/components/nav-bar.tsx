...
import { Leaf, Home, User, ShoppingBag, Flower2, LayoutDashboard } from "lucide-react"
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-[#f0ebe1] border-t border-[#e5dfd3] md:top-0 md:bottom-auto">
      <div className="container mx-auto px-4">
        <div className="flex justify-around items-center h-16 md:h-20">
          {isLoggedIn ? (
            <Link href="/dashboard" className="flex items-center gap-2 text-[#5d6b5d] hover:text-[#6b8e6b]">
